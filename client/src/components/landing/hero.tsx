...
export default function Hero() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center -mt-8 overflow-hidden bg-gradient-to-b from-background to-secondary/5">
      <div className="flex flex-col items-center justify-center gap-12 w-full">
        ...
        >
          <h1 className="text-4xl font-bold tracking-tighter sm:text-6xl xl:text-7xl/none text-foreground pb-2.5">
          ...
          <p className="max-w-[600px] text-zinc-500 md:text-xl dark:text-zinc-400 mx-auto pt-2.5">
